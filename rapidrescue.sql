...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./themes/darkwolf/jquery/jquery-ui.css">
  ...
  <link rel="stylesheet" type="text/css" href="./themes/darkwolf/css/theme.css?v=5.2.1">
  <title>localhost / localhost | phpMyAdmin 5.2.1</title>
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"57326c35587e70292f4a2e3f45576b5e",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.1",auth_type:"cookie",user:"newuser"});
var firstDayOfCalendar = '0';
var themeImagePath = '.\/themes\/darkwolf\/img\/';
...
<body>
    <div id="pma_navigation" class="d-print-none" data-config-navigation-width="264">
    ...
    <div id="pma_navigation_content">
      <div id="pma_navigation_header">
                  ...
                  <div id="pmalogo">
                          <a href="index.php">
                                      <img id="imgpmalogo" src="./themes/darkwolf/img/logo_left.png" alt="phpMyAdmin">
                                      </a>
                      </div>
  ...
  <a href="index.php?route=/table/recent-favorite&db=rapidrescue&table=admin">
    `rapidrescue`.`admin`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=rapidrescue&table=user">
    `rapidrescue`.`user`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=rapidrescue&table=emergency_requests">
    `rapidrescue`.`emergency_requests`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=rapidrescue&table=emt">
    `rapidrescue`.`emt`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=rapidrescue&table=ambulances">
    `rapidrescue`.`ambulances`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=rapidrescue&table=driver">
    `rapidrescue`.`driver`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=rapidrescue&table=feedback">
    `rapidrescue`.`feedback`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.cmFwaWRyZXNjdWU=" data-vpath="cm9vdA==.cmFwaWRyZXNjdWU=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=rapidrescue"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=rapidrescue" title="Structure">rapidrescue</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="57326c35587e70292f4a2e3f45576b5e">
...
<tr>
  ...
  <td>
          <input type="number" name="NavigationWidth" id="NavigationWidth" value="264" class="custom">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="rapidrescue" targettable="emergency_requests">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `emergency_requests`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="rapidrescue" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="rapidrescue" targettable="feedback">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `feedback`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="rapidrescue" targettable="emt">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `emt`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="rapidrescue" targettable="emergency_requests">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `emergency_requests`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="rapidrescue" targettable="driver">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `driver`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="rapidrescue" targettable="ambulances">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `ambulances`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="rapidrescue" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `admin` (`admin_id`, `name`, `email`, `password`) VALUES (NULL, &#039;admin&#039;, &#039;admin@gmail.com&#039;, &#039;admin&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="rapidrescue" targettable="admin">
                            <div class="action_content">
